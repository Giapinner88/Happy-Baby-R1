...
Mirrors the subprocess pattern in unitree_speaker.py but for the mic (input)
...
Usage:
    uv run python test_mic.py [network_interface] [seconds] [out_wav_path]
"""
...
BRIDGE_PATH = Path(__file__).resolve().parent / "unitree_bridge" / "build" / "r1_bridge"
