...
# Tự động nạp cấu hình mạng ảo cho CycloneDDS để 2 phần mềm dò được nhau
os.environ["CYCLONEDDS_URI"] = "file:///home/khanh248/Documents/HB/Mujoco/cyclonedds_lo.xml"
...
if __name__ == "__main__":
    ...
    if _args.init_csv:
        ...
        if not csv_path.exists():
            ...
            log_dir = Path(__file__).parent / "sim_state_logs"
