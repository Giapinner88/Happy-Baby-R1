...
private:
    ...
    unitree::robot::g1::subscription::LowCmd low_cmd{};  
    unitree::robot::g1::publisher::LowState low_state{};  
  
    ChannelPublisherPtr<unitree::robot::g1::subscription::LowCmd> lowcmd_publisher;  
    ChannelSubscriberPtr<unitree::robot::g1::publisher::LowState> lowstate_subscriber;  
