...
FRAMEWORKS = {
    "mjlab": Framework(
        ...
        train=[sys.executable, str(ROOT / "scripts" / "r1_mjlab_train.py")],
        play=[sys.executable, str(ROOT / "scripts" / "r1_mjlab_play.py")],
    ...
    "rl_lab": Framework(
        ...
        train=[sys.executable, str(ROOT / "scripts" / "r1_rl_lab_train.py")],
        play=[sys.executable, str(ROOT / "scripts" / "r1_rl_lab_play.py")],
...
def cmd_status(_: argparse.Namespace) -> None:
    ...
    print(f"r1 usd:    {ROOT / 'asset' / 'R1' / 'R1.usd'}")
...
def cmd_train(args: argparse.Namespace) -> None:
    ...
    if args.framework == "mjlab":
        if args.profile == "flat_v2":
            if args.terrain != "flat":
                raise SystemExit("--profile flat_v2 is only defined for --terrain flat.")
            task = "Unitree-R1-FlatV2"
        else:
...
def build_parser() -> argparse.ArgumentParser:
    ...
    train.add_argument("--profile", choices=["default", "flat_v2"], default="default")
