...
* ID buổi test: `[YYYYMMDD]_[Tên_Kịch_Bản]_[Lần_Thử_Nghiệm]`
* Ngày thực hiện:
* Nhân sự: Operator: ________ | Safety Lead: ________
* Môi trường: (Simulation / Hardware thật)
...
2. Các bước thực hiện:
	* Bước 1...
	* Bước 2...
3. Kết quả (Result): (Thành công / Thất bại / Thành công một phần).
...
* Link Rosbag2: (Đường dẫn tới file log dữ liệu)
